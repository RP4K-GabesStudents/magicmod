...
public class Rusty extends Structure {
    ...
    protected Rusty(StructureSettings config, Holder<StructureTemplatePool> startpool, Optional<ResourceLocation> jigsaw_origin, int size, HeightProvider start_height, Optional<Heightmap.Types> project_start_height_map, int max_distance_from_center) {
        super(config);
        STARTPOOL = startpool;
    ...
    public static final Codec<Rusty>CODEC = RecordCodecBuilder.<Rusty>mapCodec(objectInstance ->
            objectInstance.group(Rusty.settingsCodec(objectInstance),
                    ...
                    ).apply(objectInstance, Rusty::new)
            ).codec();
/*
...
*/
    ...
    public Optional<GenerationStub> findGenerationPoint(GenerationContext context) {
        //if (!Rusty.extraSpawnChecks(context))
    ...
    public StructureType<?> type() {
        return ModStructures.RUSTY.get();
    }
