...
public class Tent extends Structure {
    ...
    protected Tent(StructureSettings config, Holder<StructureTemplatePool> startpool, Optional<ResourceLocation> jigsaw_origin, int size, HeightProvider start_height, Optional<Heightmap.Types> project_start_height_map, int max_distance_from_center) {
        super(config);
        STARTPOOL = startpool;
    ...
    public static final Codec<Tent>CODEC = RecordCodecBuilder.<Tent>mapCodec(objectInstance ->
            objectInstance.group(Tent.settingsCodec(objectInstance),
    ...
    public Optional<GenerationStub> findGenerationPoint(GenerationContext context) {
        if (!Tent.extraSpawnChecks(context))
