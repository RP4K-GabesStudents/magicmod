...
public class Sylvr extends Structure {
    ...
    protected Sylvr(StructureSettings config, Holder<StructureTemplatePool> startpool, Optional<ResourceLocation> jigsaw_origin, int size, HeightProvider start_height, Optional<Heightmap.Types> project_start_height_map, int max_distance_from_center) {
        super(config);
        STARTPOOL = startpool;
    ...
    public static final Codec<Sylvr>CODEC = RecordCodecBuilder.<Sylvr>mapCodec(objectInstance ->
            objectInstance.group(Sylvr.settingsCodec(objectInstance),
                    ...
                    ).apply(objectInstance, Sylvr::new)
            ).codec();
/*
...
*/
    ...
    public Optional<GenerationStub> findGenerationPoint(GenerationContext context) {
        //if (!Sylvr.extraSpawnChecks(context))
    ...
    public StructureType<?> type() {
        return ModStructures.SYLVER.get();
    }
